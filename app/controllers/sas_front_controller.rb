class SasFrontController < ApplicationController
  ...
  def upload
    ...
    UserMailer.sas_mail(['james.hughes@atmel.com', 'mike.flanagan@atmel.com', 'james.lutinski@atmel.com', 'karey.klaus@atmel.com', 'jane.stang@atmel.com','dl-pen-fp-expedite@atmel.com','dl-pen-mem-bp@atmel.com', @userEmail ], @uploaded_io.original_filename).deliver
